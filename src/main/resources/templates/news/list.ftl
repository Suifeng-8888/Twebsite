        ...
        data_table = table.render({
            ...
            cols: [
                [
                    ...
                    {field:'ntime', title:'日期',width:120, align:'center'},
                    {field:'author', title: '作者', align:'center',width:150,edit:'text'},
                    {field:'nimg', title: '封面',width:100, align:'center',templet:function(d){
                            var str = '<img class="layui-nav-img user-imgs" src="'+d.nimg+'" class="layui-nav-img" style="background-color: black">\n' ;
                            return str;
                        }},
